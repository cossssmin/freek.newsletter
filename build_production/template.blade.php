...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <head>
    ...
    <style>
      ...
      .o-ml-24 {margin-left: 24px !important;}
    </style>
  <![endif]-->
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased;">
    <div role="article" aria-roledescription="email" aria-label lang="en" style="font-family: Whitney SSm A, Whitney SSm B, -apple-system, 'Segoe UI', sans-serif; margin-left: auto; margin-right: auto; max-width: 600px;">
      <div style="padding: 32px 24px;">
        <!--[if mso]><table align="center" cellpadding="0" cellspacing="0" role="presentation" style="width: 600px; padding: 24px 32px;"><tr><td><![endif]-->
        <table style="width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td style="text-align: center;" align="center">
              <a href="::webViewUrl::" style="font-size: 14px; color: #374151; text-decoration: underline;">View email in browser</a>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-size: 14px; text-align: center; color: #4b5563;" align="center">
              This mail was sent using <a href="https://mailcoach.app" style="color: #374151; text-decoration: underline;">Mailcoach</a>
            </td>
          </tr>
          <tr>
            <td style="height: 16px;" height="16"></td>
              ...
              <table align="center" style="margin-left: auto; margin-right: auto;" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <th class="sm-block sm-px-0" style="padding: 16px 0 16px 16px;">
                    <img src="https://freek.dev/images/murzicoon.png" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; width: 48px;" width="48" alt>
                  </th>
                  <th class="sm-p-0 sm-block sm-text-center" style="font-weight: 400; padding: 16px; text-align: left;" align="left">
                    <h1 style="font-size: 20px; line-height: 32px; margin: 0; color: #161e2e; text-transform: uppercase; text-decoration: none;">freek.dev</h1>
                    <p style="margin: 0; color: #374151;">Hi, welcome to the {{ $editionNumber }} freek.dev newsletter!</p>
                  </th>
                </tr>
              </table>
            </td>
        ...
        <ul style="list-style-type: none; margin: 0; padding: 0;">
          ...
          <li style="color: #ffffff;">
            <h2 style="margin-bottom: 2px;">
              <a href="{{ $post->promotional_url }}" style="font-size: 18px; color: #161e2e; text-decoration: none;">{{ $post->title }}</a>
            </h2>
            ...
            <td style="background-color: #ebf5ff; padding: 24px;" bgcolor="#ebf5ff">
              ...
              <ul align="left" class="o-ml-24" style="font-size: 16px; list-style-type: disc; margin: 0 0 0 20px; padding: 0;">
                ...
                <li style="margin: 0 0 4px; text-align: left;">
                  <a href="{{ $tweet->promotional_url }}" style="color: #252f3f;">{{ $tweet->title }}</a>
                </li>
                @endforeach
              </ul>
            </td>
        ...
        <table style="width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td style="background-color: #fff8f1; padding: 24px;" bgcolor="#fff8f1">
              ...
              <p style="font-size: 16px; margin: 0 0 16px; color: #161e2e;">Did you write or stumbled across a blog post, tutorial or video that might be good to appear in this section? <a href="https://freek.dev/links" style="color: #252f3f;">Submit it here</a>.</p>
              <ul align="left" class="o-ml-24" style="font-size: 16px; list-style-type: disc; margin: 0 0 0 20px; padding: 0;">
                @foreach($communityLinks as $link)
                <li style="margin: 0 0 4px; text-align: left;">
                  <a href="{{ $link->url }}" style="color: #252f3f;">{{ $link->title }}</a> (submitted by {{ $link->user->name }})
                </li>
                @endif
              </ul>
            </td>
        ...
        <p style="font-size: 14px; margin: 0; text-align: center; color: #4b5563;">Thanks for reading! Did you like this edition of the newsletter?</p>
        <table style="width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td style="padding: 32px 0; text-align: center; vertical-align: top; width: 50%;" width="50%" align="center" valign="top">
              <a href="{{ route('newsletter.like', ['edition' => $editionNumber]) }}" class="sm-text-lg sm-leading-32 hover-bg-green-400" style="background-color: #84e1bc; border-radius: 4px; display: inline-block; font-size: 24px; padding: 12px 24px; text-align: center; color: #ffffff; text-decoration: none;">
                <!--[if mso]><i style="letter-spacing: 24px; mso-font-width: -100%; mso-text-raise:24px;">&nbsp;</i><![endif]--><span style="mso-text-raise: 12px;">Yes!</span>
            ...
            <td style="padding: 32px 0; text-align: center; vertical-align: top; width: 50%;" width="50%" align="center" valign="top">
              <a href="{{ route('newsletter.dislike', ['edition' => $editionNumber]) }}" class="sm-text-lg sm-leading-32 hover-bg-red-400" style="background-color: #f8b4b4; border-radius: 4px; display: inline-block; font-size: 24px; padding: 12px 24px; text-align: center; color: #ffffff; text-decoration: none;">
                <!--[if mso]><i style="letter-spacing: 24px; mso-font-width: -100%; mso-text-raise:24px;">&nbsp;</i><![endif]--><span style="mso-text-raise: 12px;">Nope...</span>
                <!--[if mso]><i style="letter-spacing: 24px; mso-font-width: -100%;">&nbsp;</i><![endif]--></a>
